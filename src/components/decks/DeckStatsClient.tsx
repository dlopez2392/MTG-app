      ...
      <PageContainer>
        <div className="flex flex-col gap-6 max-w-2xl">
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="bg-bg-card border border-border rounded-xl p-4 text-center">
              <p className="text-2xl font-bold text-text-primary">{stats.averageCmc.toFixed(2)}</p>
              <p className="text-xs text-text-muted mt-1">Avg CMC</p>
            </div>
            <div className="bg-bg-card border border-border rounded-xl p-4 text-center">
              <p className="text-2xl font-bold text-text-primary">${stats.totalValue.toFixed(2)}</p>
