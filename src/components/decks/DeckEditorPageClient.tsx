...
import DeckActionsMenu, { type DeckActionItem } from "@/components/decks/DeckActionsMenu";
          ...
          <div className="flex items-center gap-2">
            ...
            <DeckActionsMenu
              items={(() => {
                ...
                const items: DeckActionItem[] = [];
                if (isLoaded && isSignedIn) {
                  items.push({
                    key: "public",
                    label: deck?.public ? "Make private" : "Make public",
                    active: !!deck?.public,
                    icon: (
                      <svg className={iconCls} {...stroke}>
