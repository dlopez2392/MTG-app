...
export default function BinderCard({
  ...
  return (
    <div className={cn("relative group", className)}>
      <Link
        href={`/collection/${id}`}
        className="relative overflow-hidden rounded-xl border border-border glass-card aspect-[3/4] flex flex-col justify-end block transition-all duration-200 active:scale-[0.97] hover:border-accent/40 hover:shadow-lg hover:shadow-accent/15"
      >
        {/* Background image */}
        {coverImageUri ? (
          <div
