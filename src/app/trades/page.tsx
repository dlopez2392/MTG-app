  ...
  return (
    <div className="flex flex-col min-h-screen pb-20">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-border">
        <button onClick={onBack} className="w-8 h-8 rounded-xl flex items-center justify-center text-white btn-gradient active:scale-90 transition-all -ml-1">
...
export default function TradesPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen pb-20 animate-page-enter">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-border">
        <button onClick={() => router.back()} className="w-8 h-8 rounded-xl flex items-center justify-center text-white btn-gradient active:scale-90 transition-all -ml-1">
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" />
          </svg>
        </button>
